...
if __name__ == "__main__":
    ...
    #bayes_clf1 = bayes.Bayesian_MultinomialNB(priors="uniform")
    bayes_clf2 = bayes.Bayesian_MultinomialNB(priors="uniform", X_estim=seq_estim_data, y_estim=seq_estim.targets, kmers=all_words_data)

    ## Train a Bayesian Markov classifier
    #markov_clf1 = bayes.Bayesian_MarkovModel(priors="uniform")
    #markov_clf2 = bayes.Bayesian_MarkovModel(priors="uniform", X_estim=seq_estim_data, y_estim=seq_estim.targets, kmers=all_words_data, kmers_backs=all_backs_data)
