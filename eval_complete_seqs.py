...
def clf_evaluation(classifiers, X, y, cv_iter=10, scoring=["f1_weighted"],
        random_state=None, verbose=False):
    ...
    skf = StratifiedKFold(n_splits=cv_iter, shuffle=False, random_state=random_state)
    ...
    for clf_ind in classifiers:
        ...
        scores[clf_dscp] = cross_validate(clf, X, y, cv=skf, scoring=scoring)
