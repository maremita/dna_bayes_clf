...
eval_clfs = {
        ...
        5: [bayes.MLE_MarkovModel(priors=priors), True, "MLE_Markov"],
        6: [bayes.Bayesian_MarkovModel(priors=priors, alpha=1e-100), True, "BAY_Markov_Alpha_1e-100"],
        7: [bayes.Bayesian_MarkovModel(priors=priors, alpha=1e-10), True, "BAY_Markov_Alpha_1e-10"],
        8: [bayes.Bayesian_MarkovModel(priors=priors, alpha=1e-5), True, "BAY_Markov_Alpha_1e-5"],
        9: [bayes.Bayesian_MarkovModel(priors=priors, alpha=1), True, "BAY_Markov_Alpha_1"],

        10:  [LogisticRegression(multi_class='ovr', solver='liblinear', penalty="l1", max_iter=1500), False, "SK_Ovr_LR_Liblinear_L1"],
